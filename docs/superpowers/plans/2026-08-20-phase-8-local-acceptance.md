...
- [x] **Step 3: Implement the minimal sequential runner**
...
- [x] **Step 4: Add the package command and rerun the focused test**
...
- [x] **Step 1: Write the daily-use guide**
...
- [x] **Step 2: Write the pre-launch checklist**
...
- [x] **Step 3: Link both documents from README and review every link and command**
...
- [x] **Step 1: Ensure the local database and website are healthy**
...
- [x] **Step 4: Check mobile public routes in the browser**
...
- [x] **Step 5: Handle any reproducible defect with TDD**
...
- [x] **Step 2: Review repository safety**
